    ...
    <div id="features">
      <div className="max-w-7xl mx-auto py-20 px-6 md:px-12 xl:px-6">
        <div className="md:w-2/3 lg:w-1/2">
          ...
          <p className="text-gray-600 dark:text-gray-300">SnapMyDesign leverages cutting-edge AI to bring your creative visions to life. Upload a sample, type a prompt, and watch as stunning designs are generated instantly. Perfect for freelancers, designers, and marketers.</p>
        </div>
        <div
            ...
            <div className="relative space-y-8 py-12 p-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Create stunning graphics with just a prompt and a sample image.
                </p>
              </div>
              <Link to="/login" className="flex items-center justify-between group-hover:text-secondary">
          ...
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="relative space-y-8 py-12 p-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Tailor your designs with endless options for styles and formats.
                </p>
              </div>
              <Link to="/login" className="flex items-center justify-between group-hover:text-secondary">
                <span className="text-sm">Try now</span>
          ...
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="relative space-y-8 py-12 p-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Get your designs in seconds, saving you valuable time.
                </p>
              </div>
              <Link to="/login" className="flex items-center justify-between group-hover:text-secondary">
                <span className="text-sm">Try now</span>
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Connect with fellow creators and share your amazing designs.
                </p>
              </div>
              <Link to="/login" className="flex items-center justify-between group-hover:text-secondary">
                <span className="text-sm">Try now</span>
